...
$(function () {
    ...
    var bsStepper = document.querySelector('.wizard-step-container');
    var horizontalWizard = document.querySelector('.property-wizard');
    var numberedStepper = new Stepper(horizontalWizard);
    if (bsStepper) {
      var stepper = new Stepper(bsStepper);
