                ...
                <div class="col-xl-4 col-md-6 wow fadeInUp">
                    <div class="property-box">
                        <div class="property-image">
                            <div class="property-slider color-6">
                                <a href="javascript:void(0)">
                                    <img src="{{ URL::asset('sheltos/assets/images/property/22.jpg') }}" class="bg-img" alt="">
                                ...
                                <a href="javascript:void(0)">
                                    <img src="{{ URL::asset('sheltos/assets/images/property/21.jpg') }}" class="bg-img" alt="">

                                </a>
                                <a href="javascript:void(0)">
                                    <img src="{{ URL::asset('sheltos/assets/images/property/23.jpg') }}" class="bg-img" alt="">
                        ...
                        <div class="property-details">
                            ...
                            <ul>
                                <li><img src="https://themes.pixelstrap.com/sheltos/assets2/images/svg/icon/double-bed.svg" class="img-fluid" alt="">Bed : 4</li>
                                <li><img src="https://themes.pixelstrap.com/sheltos/assets2/images/svg/icon/bathroom.svg" class="img-fluid" alt="">Baths : 4</li>
                ...
                {{-- <div class="col-xl-4 col-md-6 wow fadeInUp">
                    <div class="property-box">
                        ...
                        <div class="property-details">
                            ...
                            <p class="font-roboto">This home provides wonderful entertaining spaces with a chef kitchen opening. Elegant retreat in a quiet Coral Gables setting..</p>
                            <ul>
                                <li><img src="https://themes.pixelstrap.com/sheltos/assets2/images/svg/icon/double-bed.svg" class="img-fluid" alt="">Bed : 4</li>
                                <li><img src="https://themes.pixelstrap.com/sheltos/assets2/images/svg/icon/bathroom.svg" class="img-fluid" alt="">Baths : 4</li>
                                <li><img src="https://themes.pixelstrap.com/sheltos/assets2/images/svg/icon/square-ruler-tool.svg" class="img-fluid ruler-tool" alt="">Sq Ft : 5000</li>
                    ...
                    <div class="property-box">
                        <div class="property-image">
                            <div class="property-slider color-6">
                                ...
                                <a href="javascript:void(0)">
                                    <img src="{{ URL::asset('sheltos/assetsassets2/images/property/23.jpg') }}" class="bg-img" alt="">
                ...
                <div class="col-xl-4 col-md-6 wow fadeInUp">
                    <div class="property-box">
                        <div class="property-image">
                            <div class="property-slider color-6">
                                <a href="javascript:void(0)">
                                    <img src="{{ URL::asset('sheltos/assets/images/property/24.jpg') }}" class="bg-img" alt="">
                ...
                <div class="col-xl-4 col-md-6 wow fadeInUp">
                    <div class="property-box">
                        <div class="property-image">
                            <div class="property-slider color-6">
                                <a href="javascript:void(0)">
                                    <img src="{{ URL::asset('sheltos/assets/images/property/25.jpg') }}" class="bg-img" alt="">
