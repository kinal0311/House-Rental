...
<!-- Mirrored from themes.pixelstrap.com/sheltos/main/grid-3-right-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Jan 2025 12:54:43 GMT -->
<head>
                ...
                <div>
                    ...
                    <nav aria-label="breadcrumb" class="theme-breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Sale Properties</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row ratio_63">
                <div class="col-xl-9 col-lg-8 property-grid-2">
                    ...
                    <div class="property-wrapper-grid list-view">
                        <div class="property-2 row column-sm zoom-gallery property-label property-grid list-view" id="saleProperties-item">
                                ...
                                <form id="filter-form" method="GET">
                                    ...
                                    <div class="row gx-2">
                                        ...
                                        <div class="col-12 d-flex justify-content-between mt-3">
                                            <button type="submit" class="btn btn-gradient color-2 btn-pill" id="search-btn3">Search</button>
...
<script>
    $('#search-btn3').click(function(event) {
        ...
        var searchUrl = "{{ route('saleSearchProperties') }}";  // Your route name
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (Array.isArray(response.html) && response.html.length > 0) {
                    $('#saleProperties-item').empty();

                    response.html.forEach(function(property) {
                        console.log("sale-property::::::", property);
                            ...
                            <div class="col-xl-4 col-md-6 grid-item wow fadeInUp ${property.status}">
                                <div class="property-box">
                                    ...
                                    // Append to DOM
                                    $('#saleProperties-item').append(propertyHTML);
                    ...
                    $('#saleProperties-item').html('<p>No properties found.</p>');
                }
            },
    ...
    var originalContent = $("#saleProperties-item").html(); // Store original content

    $("#reset-btn").click(function () {
        $("#filter-form")[0].reset(); // Reset the filter form
        $("#saleProperties-item").html(originalContent); // Restore original content
