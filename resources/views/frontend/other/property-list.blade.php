...
$(document).ready(function () {
    $('#filter-form').on('submit', function (e) {
        ...
        $.ajax({
            url: "{{ route('listing') }}", // Ensure this route returns only the properties list
            type: "GET",
            data: $(this).serialize(),
            // beforeSend: function () {
            //     $('#properties-list').html('<p>Loading properties...</p>'); // Show loading message
            // },
                success: function (response) {
                    console.log("response:::::::", response);
                    return false;

                    $('#properties-list').html(response); // Update properties list
                },
            error: function () {
...
<!-- public function index(Request $request)
    {
        ...
        return view('frontend.listing', compact( 'images', 'agents','filtered_properties'));
    } -->
