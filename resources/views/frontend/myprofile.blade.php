                ...
                <div class="col-xl-4">
                    ...
                    <div class="card mb-4 mb-xl-0">
                        ...
                        <div class="card-body text-center">
                            ...
                            @if(Auth::user()->img)
                                <img src="{{ asset( Auth::user()->img) }}" alt="Profile Image" class="img-account-profile rounded-circle mb-2" style="max-width: 350px;">
                            @else
                                <img src="https://via.placeholder.com/150" alt="Default Profile Image" class="img-account-profile rounded-circle mb-2" style="max-width: 350px;">
                            @endif
                        ...
                        <div class="card-body">
                            <form>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="name" name="name" type="text" placeholder="Enter your name" value=" {{ Auth::user()->name }}" readonly>
                                </div>
                                <!-- Form Row-->
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control" id="phone_number" type="text" name="phone_number" placeholder="Enter your phonenumber" value="{{ Auth::user()->phone_number }}" readonly>
                                    </div>
                                </div>
                                <!-- Form Row        -->
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control" id="gender" type="text" name="gender" placeholder="Enter your gender" value="{{ Auth::user()->gender }}" readonly>
                                    </div>
                                    <!-- Form Group (location)-->
                                    <div class="col-md-6">
                                        <label class="small mb-1" for="Birth Of Date">Birth Of Date</label>
                                        <input class="form-control" id="dob" type="text" name="dob" placeholder="Enter your location" value="{{ \Carbon\Carbon::parse(Auth::user()->dob)->format('d M Y') }}" readonly>
                                    </div>
                                </div>
                                {{-- <!-- Form Group (email address)-->
                                <div class="mb-3">
                                    <label class="small mb-1" for="Description">Email address</label>
                                ...
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control" id="Address" type="text" name="address" placeholder="Enter your address" value="{{ Auth::user()->address }}" readonly>
                                    </div>
                                    <!-- Form Group (birthday)-->
                                    <div class="col-md-6">
                                        <label class="small mb-1" for="ZIP Code">ZIP Code</label>
                                        <input class="form-control" id="zip_code" type="text" name="zip_code" placeholder="Enter your zip code" value="{{ Auth::user()->zip_code }}" readonly>
                                    </div>
                                </div>
                                <!-- Save changes button-->
