                ...
                <div class="row">
                    <div class="col-xl-3">
                        <div class="footer-details text-center">
                            <a href="{{ route('home') }}">
                                <img src="{{ URL::asset('sheltos/assets/images/logo/footer-logo.png')}} " alt="">
                            </a>
                            ...
                            <ul class="icon-list">
                                ...
                                <li><a href="3"><i class="fas fa-envelope"></i></a></li>
                            ...
                            <div class="col-lg-2 col-md-4">
                                <div class="footer-links">
                                    ...
                                    <ul class="footer-content">
                                        ...
                                        <li>
                                            <a href="{{ route('agent-grid')}}">Agents</a>
                                        </li>
                                        <li>
                                            <a href="#">Pricing</a>
                                        </li>
                                ...
                                <div class="footer-slider">
                                        ...
                                        <div class="media">
                                            <a href="#">
                                                <div class="img-overlay">
                                                        <img src="{{ URL::asset('sheltos/assets/images/footer/1.jpg')}}" alt="">
                                                </div>
                                            </a>
                                    ...
                                    <div>
                                        <div class="media">
                                            <a href="#">
                                                <div class="img-overlay">
                                                        <img src="{{ URL::asset('sheltos/assets/images/footer/2.jpg')}}" alt="">
                                                </div>
                                            </a>
                                            <div class="media-body">
                                    ...
                                    <div>
                                        <div class="media">
                                            <a href="#">
                                                <div class="img-overlay">
                                                        <img src="{{ URL::asset('sheltos/assets/images/footer/3.jpg')}}" alt="">
                                                </div>
                                            </a>
                                            <div class="media-body">
                                               <h6><a href="#">Estate Agents Work</a></h6>
                                    ...
                                    <div>
                                        <div class="media">
                                            <a href="#">
                                                <div class="img-overlay">
                                                        <img src="{{ URL::asset('sheltos/assets/images/footer/4.jpg')}}" alt="">
                                                </div>
                                            </a>
                                            <div class="media-body">
                                                <h6><a href="#">Increase in Demand</a></h6>
