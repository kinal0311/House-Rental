...
<!-- range slider css -->
<link href="{{ URL::asset('sheltos/assets/css/jquery-ui.css')}}" rel="stylesheet" type="text/css" />
<!-- animate css -->
<link href="{{ URL::asset('sheltos/assets/css/animate.css')}}" rel="stylesheet" type="text/css" />
