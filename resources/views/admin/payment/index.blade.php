		...
		<div class="col-xl-12">
			<div class="card">
				<div class="card-body table-responsive" >
					<table id="paymentDataTable" class="table table-hover mb-0" style="width:100%">
                        <thead>
                            <tr>
                                <th>Id</th>
                                <th>Property Name</th>
...
@section('script')
<script>
    var dateTableUrl = "{{ route('admin.payment-getData') }}";
    // var deleteRowUrl = "{{ route('admin.properties.destroy', ':id') }}";

</script>
<script src="{{asset('assets/js/pages/admin/payment/index.js')}}"></script>
